/**
 * The Cy Fair wordmark, inlined from assets/cyf-logo.svg.
 *
 * Kept as a component (rather than an <img>) so the two brand colours can be
 * driven per-context — the header needs a light mark over the video hero and a
 * navy one once the page scrolls, without a second asset or a flash on swap.
 */
type LogoProps = {
  /** Wordmark + car. Defaults to the brand navy. */
  primary?: string;
  /** Swoosh + "DRIVING SCHOOL" subtitle. Defaults to the brand sky blue. */
  secondary?: string;
  className?: string;
  title?: string;
};
